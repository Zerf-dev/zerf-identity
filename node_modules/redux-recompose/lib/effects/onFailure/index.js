...
function onFailure() {
  ...
  return function (state, action) {
    ...
    var newValues = (_newValues = {}, (0, _defineProperty2["default"])(_newValues, "".concat(action.target, "Error"), selector(action, state)), (0, _defineProperty2["default"])(_newValues, "".concat(action.target, "Loading"), false), _newValues);
